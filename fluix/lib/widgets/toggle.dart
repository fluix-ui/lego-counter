...
class FluidToggle extends StatefulWidget {
  ...
  @override
  _FluidToggleState createState() => _FluidToggleState();
...
class _FluidToggleState extends State<FluidToggle> with TickerProviderStateMixin {
  @override
  Widget build(BuildContext context) {
    ...
    return Opacity(
      ...
      child: _CupertinoSwitchRenderObjectWidget(
        value: widget.value,
        activeColor: widget.activeColor ?? theme.primary,
        inactiveColor: widget.inactiveColor ?? theme.toggleBackground,
        onChanged: widget.enabled != null && !widget.enabled ? null : widget.onChanged,
        vsync: this,
...
const double _kTrackWidth = 54.0;
const double _kTrackHeight = 33.0;
...
const double _kSwitchWidth = 60.0;
const double _kSwitchHeight = 35.0;
// Opacity of a disabled switch, as eye-balled from iOS Simulator on Mac.
const double _kCupertinoSwitchDisabledOpacity = 0.5;

const Color _kTrackColor = Liquids.sensitiveGrey;
...
class _RenderCupertinoSwitch extends RenderConstrainedBox {
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    final RRect rect = RRect.fromRectAndRadius(trackRect, const Radius.circular(_kTrackRadius));
    canvas.drawRRect(rect, paint);

    final double currentThumbExtension = 7.0 * currentReactionValue;
    final double thumbLeft = lerpDouble(
      trackRect.left + _kTrackInnerStart - 14.0,
      trackRect.left + _kTrackInnerEnd - 14.0 - currentThumbExtension,
      visualPosition,
    );
    final double thumbRight = lerpDouble(
      trackRect.left + _kTrackInnerStart + 14.0 + currentThumbExtension,
      trackRect.left + _kTrackInnerEnd + 14.0,
      visualPosition,
    );
    final double thumbCenterY = offset.dy + size.height / 2.0;

    paintThumb(canvas, Rect.fromLTRB(
      thumbLeft,
      thumbCenterY - 14.0,
      thumbRight,
      thumbCenterY + 14.0,
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder description) {
    ...
    final Paint _shadowPaint = BoxShadow(
         color: Color(0x0C000000),
         blurRadius: 4.0,
         offset: Offset(0,2),
       ).toPaint();
    final Color color = Liquids.white;
