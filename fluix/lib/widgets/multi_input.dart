...
import 'package:fluix/widgets/input.dart';

class FluidMultiInput extends StatelessWidget {
  final String hintText;
  final String errorText;
  final Widget label;
  final TextInputType keyboardType;

  const FluidMultiInput({
    this.hintText,
    this.errorText,
    this.label,
    Key key,
  ...
  Widget build(BuildContext context) {
    return FluidInput(
      ...
      keyboardType: this.keyboardType ?? TextInputType.multiline,
