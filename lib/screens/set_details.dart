                ...
                [
                  ...
                  if (item.showExisting.isNotEmpty)
                    FluidTab(
                      "In Besitz",
                      child:
                          PartTab(item.showExisting, show: TabQuantity.owned),
                    ),
                  if (item.showMissing.isNotEmpty)
                    FluidTab(
                      "Fehlend",
                      child:
                          PartTab(item.showMissing, show: TabQuantity.missing),
                    ),
                    ...
                    ? Row(
                        ...
                        children: <Widget>[
                          ...
                          FluidIconButton.highlight(
                            ...
                            child: width > 500 ? Text("Exportieren") : null,
                            onTap: () => Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) =>
                                    ExportScreen(item, selectedTab),
                              ),
                            ),
                          ),
                          FluidIconButton(
